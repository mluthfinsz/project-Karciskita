...
import java from "../assets/img/ConcertJava.jpg";
    ...
    <main>
      ...
      <Container className="mt-5">
        ...
        <div className="mt-5 d-flex justify-content-between gap-3">
          ...
          <div className="w-100">
            <h5 className="align-items-baseline">Java Jazz Festival 2024</h5>
            <div>
        ...
        >
          {[
            {
              id: "cat1",
              title: "Tiket Java Jazz 2024",
              price: "Rp350.000",
            },
            {
              id: "cat2",
              title: "Tiket masuk BNI Java Jazz Festival 2024 ",
              price: "Rp500.000",
            },
            {
              id: "cat3",
              title: "Tiket Java Jazz Festival Daily pass",
              price: "Rp450.000",
            },
          ].map((category) => (
            <li
