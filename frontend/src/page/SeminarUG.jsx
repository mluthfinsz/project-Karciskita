...
import a7x from "../assets/img/Seminar2.jpg";
        ...
        <div className="mt-5 d-flex justify-content-between gap-3">
          ...
          <div className="w-100">
            <h5 className="align-items-baseline">
              WEBINAR NASIONAL KONSELING ADIKSI
            </h5>
            <div>
              ...
              <p style={{ width: "40rem" }}>
                Jangan lewatkan kesempatan untuk memahami secara mendalam
                tentang Adiksi dan Pemulihannya. Daftar segera dan mulailah
                perjalanan hidup yang lebih sehat dan bahagia
              </p>
            </div>
          </div>
        </div>
