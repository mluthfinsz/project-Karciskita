...
import Soundfest from "../assets/img/Concert1.1.jpg";
    ...
    <main>
      ...
      <Container className="mt-5">
        ...
        <div className="mt-5 d-flex justify-content-between gap-3">
          ...
          <div className="w-100">
            <h5 className="align-items-baseline">Soundfest</h5>
            <div>
              ...
              <p className="gap-3 d-flex align-items-center">
                <MdOutlineDateRange />
                27 Jul 2024 - 28 Jul 2025
              </p>

              <p style={{ width: "40rem" }}>-</p>
            </div>
          </div>
        </div>
        ...
        >
          {[
            {
              id: "cat1",
              title: "Super Festival (Premium)",
              price: "Rp300.000",
            },
            { id: "cat2", title: "Festival Presale 3 ", price: "Rp200.000" },
            { id: "cat3", title: "Love Package", price: "Rp350.000" },
          ].map((category) => (
            <li
              key={category.id}
