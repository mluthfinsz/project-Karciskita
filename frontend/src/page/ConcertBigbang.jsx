...
import bigbang from "../assets/img/Concert1.2.jpg";
      ...
      <Container className="mt-5">
        ...
        <div className="mt-5 d-flex justify-content-between gap-3">
          ...
          <div className="w-100">
            ...
            <div>
              ...
              <p style={{ width: "40rem", textAlign: "justify" }}>
                Pameran Cuci Gudang Terbesar tahun ke -7 yang diselenggarakan
                pada tanggal 22 Desember 2024 sampai 1 Januari 2025 di JIExpo
                Kemayoran. Destinasi liburan akhir tahun dan belanja dengan
                diskon up to 90% dalam berbagai produk mulai dari Fashion,
                Beauty, Elektronik, Furniture, Home Appliance, Toys Fair dan
                Multiproduk lainnya. Ada Festival Kuliner juga dengan beragam
                jenis jajanan khas dan kekinian. Tidak ketinggalan Festival
                Musik selama 12 hari dan penampilan artis-artis ternama tanah
                air juga akan meramaikan Big Bang Jakarta 2024.
              </p>
            </div>
          </div>
        </div>
        ...
        >
          {[
            {
              id: "cat1",
              title: "Tiket Terusan Presale 1 ",
              price: "Rp150.000",
            },
            {
              id: "cat2",
              title: "Blind Tiket Konser Premium",
              price: "Rp250.000",
            },
            {
              id: "cat3",
              title: "Tiket PREMIUM 12DayPass",
              price: "Rp1.000.000",
            },
          ].map((category) => (
            <li
